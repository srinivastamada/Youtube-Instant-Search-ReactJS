...
state = {
    ...
    var urlKey = '&key=AIzaSyCjNV7ZkVQVFUNf4Kz4wEzlz0I8mYP52PU&maxResults=18&part=snippet';
  ...
  <input type="text" className="form-control" id="searchKey" placeholder="Search here etc: Food, Songs" onKeyUp={this.searchAction} ref="searchInput"/><br/>
